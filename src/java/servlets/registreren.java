...
public class registreren extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1> User registration completed</h1>");
            out.println("<p>Hello, "+request.getParameter("regname") +"</p>");
            out.println("</br> Your password is : '"+request.getParameter("password1")+"'");
